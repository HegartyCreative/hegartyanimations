...
lib.ssMetadata = [
		{name:"travel_728x90_atlas_", frames: [[0,0,300,300],[0,302,728,90]]}
];
...
(lib.flag = function() {
	this.spriteSheet = ss["travel_728x90_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.travel_728x90_1 = function() {
	this.spriteSheet = ss["travel_728x90_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Tween6 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(0,0,1,1,2.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-83,-129.9,166.1,259.9);
...
(lib.Tween3 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-246.8,-22);

	this.instance_1 = new lib.Tween4("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(241.8,19.2,1,1,2.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(158.8,-110.8,166.1,260);
...
// stage content:
(lib.travel_728x90 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.play_btn).to({_off:true},1).wait(94));

	// text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#20B2AA").s().p("AgWApQgJgMAAgdQAAgQADgMQADgLAIgFQAHgGAKAAQAIAAAGADQAGAEAEAFQAEAHADAJQABAIAAAOQAAARgDAMQgDAKgIAGQgHAGgLAAQgNAAgJgKgAgNghQgGAKAAAXQAAAZAGAIQAFAIAIAAQAJAAAFgIQAGgIAAgZQAAgXgGgJQgFgIgJAAQgIAAgFAHg");
	this.shape.setTransform(707.9,109.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#20B2AA").s().p("");
	this.shape_1.setTransform(700.1,109.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#20B2AA").s().p("AATAkIgPgWIgEgGIgSAcIgPAAIAagkIgYgjIAPAAIALARIAFAIIAFgIIANgRIAOAAIgZAiIAbAlg");
	this.shape_2.setTransform(688.9,111);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#20B2AA").s().p("");
	this.shape_3.setTransform(677.7,109.7);
	...
	this.shape_4.setTransform(669.8,109.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#20B2AA").s().p("AgSAyQABgNAFgQQADgRAJgPQAHgPAJgLIgvAAIAAgLIBAAAIAAAJQgKAKgJARQgKAQgEASQgEANAAAPg");
	this.shape_5.setTransform(662.2,109.7);
	...
	// band
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("Eg43ADIIAAmPMBxvAAAIAAGPg");
	this.shape_6.setTransform(364,110);

	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(95));

	// yellowLine
	this.instance = new lib.Tween6("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(594.5,-131.7);
	this.instance._off = true;

	this.instance_1 = new lib.Tween5("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(447,104.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},53).to({state:[{t:this.instance_1}]},17).wait(25));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(53).to({_off:false},0).to({_off:true,x:447,y:104.4},17).wait(25));

	// greenLine
	this.instance_2 = new lib.Tween1("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(137.9,203);
	this.instance_2._off = true;

	this.instance_3 = new lib.Tween3("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(213.9,83);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},53).to({state:[{t:this.instance_3}]},17).wait(25));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(53).to({_off:false},0).to({_off:true,x:213.9,y:83},17).wait(25));

	// bodyText
	this.instance_4 = new lib.text_body();
	this.instance_4.parent = this;
	this.instance_4.setTransform(253,128,1.148,1.148);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(25).to({_off:false},0).to({y:59,alpha:1},16).wait(54));

	// mainText
	this.instance_5 = new lib.text_main();
	this.instance_5.parent = this;
	this.instance_5.setTransform(94,-37);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({_off:false},0).to({x:92,y:45,alpha:1},16).wait(60));

	// flag
	this.instance_6 = new lib.flag_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(200,46,0.78,0.78);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:0.1,regY:0.1,x:200.1,y:46.1},9).to({regX:0,regY:0,x:200,y:46,alpha:0},8).to({_off:true},1).wait(77));

	// btn
	this.instance_7 = new lib.btn();
	this.instance_7.parent = this;
	this.instance_7.setTransform(385,66);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;
	new cjs.ButtonHelper(this.instance_7, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(41).to({_off:false},0).to({alpha:1},11).wait(43));

	// image
	this.instance_8 = new lib.travel_728x90_1();
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/travel_728x90_atlas_.png", id:"travel_728x90_atlas_"}
	],
	preloads: []
};
