...
lib.ssMetadata = [
		{name:"retail_300x250_atlas_", frames: [[0,208,70,212],[302,96,70,262],[0,0,403,94],[72,208,70,204],[0,96,300,110],[374,96,70,217]]}
];
...
(lib.A = function() {
	this.spriteSheet = ss["retail_300x250_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.retail_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#32AFA1").ss(1,1,1).p("A3b2pMAu3AAAMAAAAtTMgu3AAAg");
	this.shape.setTransform(150,125,1,0.862);
	...
	this.instance.parent = this;
	this.instance.setTransform(150,145.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({alpha:0},10).wait(196));

	// Size
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#20B2AA").s().p("AgWApQgJgNAAgcQgBgQAEgMQADgLAIgFQAHgGAKAAQAIAAAGADQAGAEAEAFQAEAHADAJQACAIAAAOQgBARgDAMQgEAKgHAGQgHAGgLAAQgNAAgJgKgAgMghQgHAKAAAXQAAAZAGAIQAGAIAHAAQAIAAAHgIQAFgIAAgZQAAgXgFgJQgHgIgIAAQgIAAgEAHg");
	this.shape_1.setTransform(281.5,269.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#20B2AA").s().p("AgXArQgIgIgBgMIAMgCQACAKAFAFQAFAEAIAAQAIAAAGgGQAGgHAAgLQAAgLgGgFQgGgGgIAAQgGAAgFADQgFADgDADIgLgCIAJgyIAxAAIAAAMIgnAAIgFAbQAJgHAJAAQANAAAJAJQAJAIAAAPQAAANgIAKQgKAMgPAAQgOAAgJgHg");
	this.shape_2.setTransform(273.8,270);
	...
	this.shape_3.setTransform(265.9,269.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#20B2AA").s().p("AATAkIgPgWIgEgGIgSAcIgPAAIAbgkIgZgjIAQAAIAKARIAFAIIAFgIIANgRIAOAAIgZAiIAbAlg");
	this.shape_4.setTransform(254.8,271.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#20B2AA").s().p("AgWApQgKgNABgcQAAgQADgMQAEgLAHgFQAHgGAKAAQAIAAAGADQAGAEAEAFQAEAHACAJQACAIAAAOQABARgEAMQgDAKgIAGQgHAGgLAAQgOAAgIgKgAgNghQgGAKAAAXQAAAZAGAIQAFAIAIAAQAJAAAFgIQAGgIAAgZQAAgXgGgJQgFgIgJAAQgIAAgFAHg");
	this.shape_5.setTransform(243.6,269.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#20B2AA").s().p("AgWApQgJgNAAgcQAAgQADgMQADgLAIgFQAHgGAKAAQAIAAAGADQAGAEAEAFQAEAHADAJQABAIAAAOQAAARgDAMQgDAKgIAGQgHAGgLAAQgNAAgJgKgAgNghQgGAKAAAXQAAAZAGAIQAFAIAIAAQAJAAAFgIQAGgIAAgZQAAgXgGgJQgFgIgJAAQgIAAgFAHg");
	this.shape_6.setTransform(235.8,269.9);
	...
	this.shape_7.setTransform(228.1,269.9);
	...
	// Band
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("A3bDIIAAmPMAu3AAAIAAGPg");
	this.shape_8.setTransform(150,270);
	...
	this.instance_1.setTransform(162,260);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(182).to({_off:false},0).to({y:233,alpha:1},10,cjs.Ease.get(-1)).wait(44));

	// sale
	this.instance_2 = new lib.sale();
	this.instance_2.parent = this;
	this.instance_2.setTransform(141,150);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(178).to({_off:false},0).to({y:176.5,alpha:1},9,cjs.Ease.get(-1)).wait(49));

	// logo
	this.instance_3 = new lib.RedJL();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-10,203);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(192).to({_off:false},0).to({x:140,y:204,alpha:1},14).wait(30));

	// E
	this.instance_4 = new lib.E_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(263,-118.5);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(151).to({_off:false},0).to({y:36},20).to({y:23.5},4).wait(61));

	// L
	this.instance_5 = new lib.L_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(191.5,-105.9);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(141).to({_off:false},0).to({y:49.1},20).to({x:191,y:36},4).wait(71));

	// A
	this.instance_6 = new lib.A_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(117.5,-112.9);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(132).to({_off:false},0).to({y:44.1},19).to({x:117,y:32},4).wait(81));

	// S
	this.instance_7 = new lib.Tween7("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(35,-114.5);
	this.instance_7._off = true;

	this.instance_8 = new lib.Tween5("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(35,41.5);
	this.instance_8._off = true;

	this.instance_9 = new lib.Tween6("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(35,28.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(122).to({_off:false},0).to({_off:true,y:41.5},19).wait(95));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(122).to({_off:false},19).to({_off:true,y:28.5},4).wait(91));

	// Night
	this.instance_10 = new lib.Night();
	this.instance_10.parent = this;
	this.instance_10.setTransform(150,145);
	...
	this.instance_11.setTransform(150,213);
	...
	this.instance_12.setTransform(150,220.2);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(41).to({_off:false},0).to({y:112.2},84).wait(111));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(41).to({_off:false},0).to({regX:0.8,regY:84.4,scaleX:0.96,scaleY:0.96,x:150.3,y:161.3,alpha:0.48},84).wait(111));
	...
	this.shape_9.setTransform(300,130,0.385,0.458,0,0,0,389.6,10.1);

	this.timeline.addTween(cjs.Tween.get(this.shape_9).wait(236));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(30,20,540,540);
// library properties:
lib.properties = {
	width: 300,
	height: 290,
	...
	webfonts: {},
	manifest: [
		{src:"images/retail_300x250_atlas_.png", id:"retail_300x250_atlas_"}
	],
	preloads: []
};
