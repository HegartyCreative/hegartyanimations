...
lib.ssMetadata = [
		{name:"travel_300x250_atlas_", frames: [[0,0,300,300],[0,302,250,250]]}
];
...
(lib.flag = function() {
	this.spriteSheet = ss["travel_300x250_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.travel_300x250_1 = function() {
	this.spriteSheet = ss["travel_300x250_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
// stage content:
(lib.travel_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(276.5,-135.5);
	this.instance._off = true;

	this.instance_1 = new lib.Tween2("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(127.5,128.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},34).to({state:[{t:this.instance_1}]},21).wait(28));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(34).to({_off:false},0).to({_off:true,x:127.5,y:128.5},21,cjs.Ease.get(-1)).wait(28));

	// greenLine
	this.instance_2 = new lib.Tween3("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-13.5,384.5);
	this.instance_2._off = true;

	this.instance_3 = new lib.Tween4("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(133.5,130.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},34).to({state:[{t:this.instance_3}]},21).wait(28));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(34).to({_off:false},0).to({_off:true,x:133.5,y:130.5},21,cjs.Ease.get(-1)).wait(28));

	// textBody
	this.instance_4 = new lib.text_body();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-53,111);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(16).to({_off:false},0).to({x:59.2,y:110.5,alpha:1},18).wait(49));

	// textMain
	this.instance_5 = new lib.text_main();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-80,42);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(9).to({_off:false},0).to({x:74.2,alpha:1},17).wait(57));

	// flag
	this.instance_6 = new lib.flag_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(67,67);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({alpha:0},6).wait(77));

	// btn
	this.instance_7 = new lib.btn();
	this.instance_7.parent = this;
	this.instance_7.setTransform(49,170.8,0.016,0.031,0,0,0,0,1.6);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;
	new cjs.ButtonHelper(this.instance_7, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(34).to({_off:false},0).to({regY:0,scaleX:1,scaleY:1,y:169.5,alpha:1},21).wait(28));

	// image
	this.instance_8 = new lib.travel_300x250_1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(51,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(83));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(150,146,301,289);
// library properties:
lib.properties = {
	width: 300,
	height: 290,
	...
	webfonts: {},
	manifest: [
		{src:"images/travel_300x250_atlas_.png", id:"travel_300x250_atlas_"}
	],
	preloads: []
};
