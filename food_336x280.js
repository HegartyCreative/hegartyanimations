...
lib.ssMetadata = [
		{name:"food_336x280_atlas_", frames: [[0,0,336,280],[236,282,48,200],[335,282,45,200],[0,282,234,144],[286,282,47,194]]}
];
...
(lib.food_336x280_1 = function() {
	this.spriteSheet = ss["food_336x280_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.food_336x280 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(71,143,0.771,0.771,0,0,0,0.1,0.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(48).to({_off:false},0).to({alpha:1},17).wait(15));

	// text
	this.instance_1 = new lib.text();
	this.instance_1.parent = this;
	this.instance_1.setTransform(133,92.2);
	...
	this.play_btn.setTransform(21,301,0.774,0.774);
	...
	// size
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#20B2AA").s().p("AgWApQgKgNAAgcQABgRADgKQAEgLAHgGQAHgGAKAAQAIAAAGADQAGADAEAGQAEAGACAJQACAJAAAOQABASgEALQgDAKgIAHQgHAFgLAAQgOAAgIgKgAgNghQgGAJAAAYQAAAZAGAIQAFAIAIAAQAJAAAFgIQAGgJAAgYQAAgYgGgIQgFgIgJAAQgIAAgFAHg");
	this.shape.setTransform(316.9,299.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#20B2AA").s().p("");
	this.shape_1.setTransform(309.2,299.9);
	...
	this.shape_2.setTransform(301.3,299.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#20B2AA").s().p("AATAkIgPgWIgEgGIgSAcIgPAAIAagkIgYgjIAPAAIALARIAFAIIAFgIIANgRIAOAAIgZAiIAbAlg");
	this.shape_3.setTransform(290.2,301.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#20B2AA").s().p("");
	this.shape_4.setTransform(279,299.9);
	...
	this.shape_5.setTransform(271.2,299.9);
	...
	this.shape_6.setTransform(263.5,299.9);
	...
	this.shape_7.setTransform(0.1,300,0.462,0.333,0,0,0,-363.7,0);
	...
	this.instance_2.setTransform(70,328,0.447,0.447);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(19).to({_off:false},0).to({x:73,y:244,alpha:1},20).wait(41));

	// knife
	this.instance_3 = new lib.knife_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(90.4,377.1,0.456,0.456,0,0,0,-21.2,99.6);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({_off:false},0).to({x:90.1,y:287.1,alpha:1},20).wait(45));

	// fork
	this.instance_4 = new lib.fork_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(46,331,0.458,0.458);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(9).to({_off:false},0).to({y:241,alpha:1},20).wait(51));

	// background
	this.instance_5 = new lib.food_336x280_1();
	this.instance_5.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(80));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(168,160,336,320);
// library properties:
lib.properties = {
	width: 336,
	height: 320,
	...
	webfonts: {},
	manifest: [
		{src:"images/food_336x280_atlas_.png", id:"food_336x280_atlas_"}
	],
	preloads: []
};
